...
<!-- Blog Content (Only visible when gate passed) -->
{#if gatePassed}
    <div class="blog-context">
        ...
        <footer class="blog-container blog-footer">
            ...
            >
                <a href="{base}/" style="text-decoration: underline;"
                    >Portfolio</a
                >
                <a
            ...
            <div class="disclaimer-accordion">
                ...
                {#if showDisclaimer}
                    ...
                    >
                        ...
                        project created solely to demonstrate technical skills.
                        All characters, names, audio, and visual assets related
                        to 'Naruto' are identifiers of and copyright to Masashi
                        Kishimoto, Shueisha, Viz Media, and TV Tokyo. No
                        copyright infringement is intended. This project is not
                        affiliated with, endorsed by, or sponsored by the
                        official copyright holders. Usage of these assets falls
                        under 'Fair Use' for educational and transformative
                        purposes.
                    </p>
                {/if}
            </div>
